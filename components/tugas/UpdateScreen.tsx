...
export default function UpdateScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {/* make content scrollable and leave space at bottom so buttons stay visible */}
      <ScrollView
        contentContainerStyle={{ padding: 10, paddingBottom: 140 }}
        showsVerticalScrollIndicator={false}
      >
        <Text style={styles.screenTitle}>Update Screen</Text>
        ...
        >
          {images.map((img, Index) => (
            <TouchableOpacity
              key={Index}
              style={[styles.boxImage, selectedImage === Index && styles.imageSelected]}
      ...
      {/* bottomBar fixed outside scroll so it stays at bottom */}
